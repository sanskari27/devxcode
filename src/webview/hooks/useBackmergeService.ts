...
export function useBackmergeService() {
    ...
    const [destinationStatus, setDestinationStatus] = useState<BranchStatus | null>(null);
            ...
            switch (message.command) {
                ...
                case 'pullSuccess':
                    ...
                    if (message.branchName === destinationBranch) {
                        ...
                        showNotification(`Successfully pulled ${destinationBranch}`, 'success');
                        // Refresh status
    ...
    const fetchSourceCommits = useCallback(
    ...
    }, [sourceBranch, sourceCommitsSkip, loadingSourceCommits, hasMoreSourceCommits, fetchSourceCommits]);
    ...
    }, [destinationBranch, destCommitsSkip, loadingDestCommits, hasMoreDestCommits, fetchDestinationCommits]);
